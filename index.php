...
<html lang="en">
  ...
  <?php if(isset($_SESSION['user_id'])); ?>
    <section class="card" style="margin: 1rem; padding: 1rem; background-color: #F6F5F2;">
    ...
    <div class="row">
        <div class="col d-flex justify-content-center">
          <div class="">
            <div class="card-body">
            <a href="index.php" class="btn btn-outline-primary">Home<i class='bx bxs-home'></i></a>
            <?php if (isset($_SESSION['user']) && isset($_SESSION['user']['user_id'])) : ?>

              <a href="tambah.php" class="btn btn-outline-primary">Unggah Foto<i class='bx bx-plus'></i></a>
              <a href="profile.php" class="btn btn-outline-primary">Profile<i class='bx bx-user' ></i></a>
              <?php else : ?>

              <a href="register.php" class="btn btn-outline-primary">Register<i class='bx bx-user-plus' ></i></a>
              <a href="login.php" class="btn btn-outline-primary">Login<i class='bx bx-log-in'></i></i></a>
              <?php endif ; ?>
                ...
                <div class="row">
                    <div class="col mb-4 "> -->
                        ...
                        <div class="card mb-4 md-6 mx-auto" style="width: 18rem;"><br>
                            ...
                            <h6><i class='bx bx-user'></i><?= $row['username'] ?></h6>
                            

                            <img src="gambar/<?php echo $row['lokasi_file']; ?>" class="card-img-top" alt="..." style="border-radius: 1rem;">
                            <div class="card-body">
